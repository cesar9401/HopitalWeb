            ...
            <section class="contenedor">
                ...
                <div class="derecha">
                    <form action="MainController" method="post" class="formulario" id="formulario" name="form1" onsubmit="return validarFormulario(this)">
                        <input type="email" id="email" class="input" name="email" placeholder="Email" value="ADMIN1" required>
                        <br />
                        <input type="password" name="pass" id="pass" class="input" name="pass" placeholder="Contraseña" value="dfDrVH~9a#-7)^w^P9pB" required>
                        <br />
